...
function LoginContent() {
  ...
  return (
    <div className="flex justify-center px-4 py-24 min-h-[80vh]">
      <div className="w-full max-w-md p-8 rounded-2xl bg-card border border-border shadow-2xl backdrop-blur-xl h-fit">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 rounded-xl bg-muted/5 border border-border text-foreground focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-mono text-sm" 
            />
          </div>
          <div>
            ...
            <input 
              ...
              placeholder="••••••••" 
              className="w-full px-4 py-3 rounded-xl bg-muted/5 border border-border text-foreground focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-mono" 
            />
          </div>
          ...
          {isRegistering && (
            <div className="mt-2 animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <div className="flex items-center gap-4 bg-muted/5 p-4 rounded-xl border border-border shadow-inner">
                <span className="text-lg font-black text-foreground italic">{captcha.a} + {captcha.b} = </span>
                <input 
                  type="number"
                  required
                  ...
                  placeholder="?"
                  className="w-20 px-3 py-2 rounded-lg bg-muted/10 border border-border text-foreground text-center font-black focus:outline-none focus:border-blue-500 transition-all"
                />
              </div>
            </div>
          )}
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          <span className="text-sm text-muted uppercase font-medium">or continue with</span>
          <div className="h-px bg-border flex-1"></div>
        </div>
        ...
        <div className="flex justify-center gap-4 mt-6">
          <button 
            ...
            disabled={loading}
            className="px-6 py-3 rounded-xl bg-muted/5 border border-border text-foreground hover:bg-muted/10 transition-colors flex items-center gap-3 w-full justify-center disabled:opacity-50"
          >
