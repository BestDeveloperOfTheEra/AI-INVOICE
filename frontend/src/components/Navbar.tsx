        ...
        {role === 'Admin' ? (
          ...
          <>
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="http://localhost:3001/api-docs" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-300 hover:text-white transition-colors">Developers API</a>
            </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-white/5 bg-black/90 backdrop-blur-xl animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="flex flex-col p-4 gap-2">
            ...
            <a href="http://localhost:3001/api-docs" target="_blank" rel="noopener noreferrer" onClick={() => setIsMobileMenuOpen(false)} className="px-4 py-3 text-sm text-gray-300 hover:bg-white/5 rounded-xl">Developers API</a>
          </div>
        </div>
      )}
    </nav>
